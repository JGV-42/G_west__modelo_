...
\section{Results}\label{anexo:resultados}

The following presents the results obtained from several model evaluation metrics on the test dataset. The section is divided according to the source of the training data (IFN2, IFN3 or IFN2 and IFN3) and according to the variable to be predicted (tonnes of carbon or tonnes of carbon per hectare).

\subsection{IFN2 as explanatory variable for \texttt{c4} (tC/ha)}

\subsubsection{Base models}

Once the models are trained, global parameters such as $R^2$, RMSE and MAE are presented in Table \ref{tab:base_comp_ifn2_c4}.

\begin{table}[tp]
    \centering
    \caption{Base Model Comparison for IFN2 (c4)}
    \label{tab:base_comp_ifn2_c4}
    \resizebox{\textwidth}{!}{
    \begin{tabular}{lcccccc}
        \toprule
        Model & $R^2_{\text{test}}$ & RMSE$_{\text{test}}$ (tC/ha) & MAE$_{\text{test}}$ (tC/ha) & wMAPE (\%) & SMAPE (\%) & Bias (tC/ha) \\
        \midrule
...
\subsubsection{Stacking models}

Table \ref{tab:stack_comp_ifn2_c4} shows the performance summary of the stacking models for predicting the carbon variable in tC/ha using the dataset that employs IFN2 as the explanatory inventory.

\begin{table}[tp]
    \centering
    \caption{Stacking Model Comparison for IFN2 (c4)}
...
\clearpage
\subsection{IFN2 as explanatory variable for \texttt{carbono\_bruto4} (tC)}

\subsubsection{Base models}

Table \ref{tab:base_comp_ifn2_carbono_bruto4} shows the performance summary of the models for predicting the carbon variable in tonnes (carbono\_bruto4) using the dataset that employs IFN2 as the explanatory inventory.

\begin{table}[tp]
    \centering
    \caption{Base Model Comparison for IFN2 (carbono\_bruto4)}
    \label{tab:base_comp_ifn2_carbono_bruto4}
    \resizebox{\textwidth}{!}{
    \begin{tabular}{lcccccc}
        \toprule
        Model & $R^2_{\text{test}}$ & \phantom{/h}RMSE$_{\text{test}}$ (tC)\phantom{a} & \phantom{/h}MAE$_{\text{test}}$ (tC)\phantom{a} & wMAPE (\%) & SMAPE (\%) & \phantom{/h}Bias (tC)\phantom{a} \\
        \midrule
...
Table \ref{tab:stack_comp_ifn2_carbono_bruto4} shows the performance summary of the stacking models for predicting the carbon variable in tonnes (carbono\_bruto4) using the dataset that employs IFN2 as the explanatory inventory.

\begin{table}[tp]
    \centering
    \caption{Stacking Model Comparison for IFN2 (carbono\_bruto4)}
...
\clearpage
\subsection{IFN3 as explanatory variable for \texttt{c4} (tC/ha)}

\subsubsection{Base models}

Once the models are trained, global parameters such as $R^2$, RMSE and MAE are presented in Table \ref{tab:base_comp_ifn3_c4}.

\begin{table}[tp]
    \centering
    \caption{Base Model Comparison for IFN3 (c4)}
...
Table \ref{tab:stack_comp_ifn3_c4} shows the performance summary of the stacking models for predicting the carbon variable in tC/ha using the dataset that employs IFN3 as the explanatory inventory.

\begin{table}[tp]
    \centering
    \caption{Stacking Model Comparison for IFN3 (c4)}
...
\clearpage
\subsection{IFN3 as explanatory variable for \texttt{carbono\_bruto4} (tC)}

\subsubsection{Base models}

Table \ref{tab:base_comp_ifn3_carbono_bruto4} shows the performance summary of the models for predicting the carbon variable in tonnes (carbono\_bruto4) using the dataset that employs IFN3 as the explanatory inventory.

\begin{table}[tp]
    \centering
    \caption{Base Model Comparison for IFN3 (carbono\_bruto4)}
...
Table \ref{tab:stack_comp_ifn3_carbono_bruto4} shows the performance summary of the stacking models for predicting the carbon variable in tonnes (carbono\_bruto4) using the dataset that employs IFN3 as the explanatory inventory.

\begin{table}[tp]
    \centering
    \caption{Stacking Model Comparison for IFN3 (carbono\_bruto4)}
...
\clearpage
\subsection{IFN2+IFN3 as explanatory variables for \texttt{c4} (tC/ha)}

\subsubsection{Base models}

Once the models are trained, global parameters such as $R^2$, RMSE and MAE are presented in Table \ref{tab:base_global_c4}.

\begin{table}[tp]
    \centering
    \caption{Global Base Models (c4)}
...
Table \ref{tab:stack_global_c4} shows the performance summary of the stacking models for predicting the carbon variable in tC/ha using the dataset that employs IFN2 and IFN3 as explanatory inventories.

\begin{table}[tp]
    \centering
    \caption{Global Stacking Models (c4)}
...
\clearpage
\subsection{IFN2+IFN3 as explanatory variables for \texttt{carbono\_bruto4} (tC)}

\subsubsection{Base models}

Table \ref{tab:base_global_carbono_bruto4} shows the performance summary of the models for predicting the carbon variable in tonnes using the dataset that employs IFN2 and IFN3 as explanatory inventories.

\begin{table}[tp]
    \centering
    \caption{Global Base Models (carbono\_bruto4)}
...
Table \ref{tab:stack_global_carbono_bruto4} shows the performance summary of the stacking models for predicting the carbon variable in tonnes using the dataset that employs IFN2 and IFN3 as explanatory inventories.

\begin{table}[tp]
    \centering
    \caption{Global Stacking Models (carbono\_bruto4)}
