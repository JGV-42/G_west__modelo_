...
\newpage
\input{sections/3.1.revision_literatura}
\newpage
\input{sections/3.2.EstadodelArte}
\newpage
...
% \bibliographystyle{plainnat}  % o unsrt, or natbib estilos numéricos
% \bibliography{referencias}    % sin .bib
