...
\input{sections_en/02_objectives}
\input{sections_en/03_literature_review}
\input{sections_en/04_state_of_the_art}
\input{sections_en/05_methodology}
\input{sections_en/06_pipeline_implementation}
\input{sections_en/07_results}
\clearpage
\input{sections_en/08_discussion}
\input{sections_en/09_conclusions}
\input{sections_en/11_acknowledgements}
