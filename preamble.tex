...
\usepackage[
    backend=biber,
    style=numeric,       % Estilo numérico [1], [2], etc.
    sorting=none,        % Ordenar por orden de aparición
...
%----------------------------------------------------------------------------------------
% SALTOS DE LÍNEA EN TEXTO MONOESPACIADO
%----------------------------------------------------------------------------------------
% Permite que LaTeX estire los espacios cuando hay \texttt{} largos que no caben en columna
