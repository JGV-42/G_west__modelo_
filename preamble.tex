...
\usepackage[
    backend=biber,   % Obligatorio para que funcione tu script
    style=numeric,       % Estilo de cita (apa, numeric, ieee, alphabetic, etc.)
    sorting=none,     % Ordenar por Nombre, Año, Título
    natbib=true       % <--- Permite usar \citep y \citet sin errores
]{biblatex}

% 2. Añadir el archivo de referencias
% NOTA: En biblatex ES NECESARIO poner la extensión .bib
...
% Redefinir \texttt para permitir quiebres de línea con \allowbreak
\let\oldtexttt\texttt
\renewcommand{\texttt}[1]{%
    \oldtexttt{\hyphenchar\font=`\-\relax #1}%
}
% Permitir quiebre de línea después de guiones bajos en modo texto
...
% Configuración del índice (tabla de contenidos)
\usepackage{tocloft}
% Aumentar el ancho del número para que haya espacio entre número y título
\setlength{\cftsecnumwidth}{3em}       % Ancho para números de sección (ej: "11.")
\setlength{\cftsubsecnumwidth}{4em}    % Ancho para números de subsección (ej: "11.1.")
\setlength{\cftsubsubsecnumwidth}{5em} % Ancho para números de subsubsección (ej: "11.1.1.")
