...
\begin{figure}
      ...
      \caption{Evolución del error absoluto y el error absoluto porcentual en cuantiles en función del periodo para el modelo LightGBM (\texttt{c4}).}
...
\begin{figure}
      ...
      \caption{Densidad de predicciones frente a valores reales para el modelo LightGBM (\texttt{c4}).}
...
\begin{figure}
      ...
      \caption{Evolución del error absoluto y el error absoluto porcentual en cuantiles en función del periodo para el modelo Stacking (Conf. 5, MLP) (\texttt{c4}).}
...
\begin{figure}
      ...
      \caption{Gráfico de puntos de las predicciones frente a los valores reales para el modelo Stacking (Conf. 5, MLP) (\texttt{c4}).}
...
\begin{figure}
      ...
      \caption{Evolución del error absoluto y el error absoluto porcentual en cuantiles en función del periodo para el modelo CatBoost (\texttt{carbono\_bruto4}).}
...
\begin{figure}
      ...
      \caption{Gráfico de puntos de las predicciones frente a los valores reales para el modelo CatBoost (\texttt{carbono\_bruto4}).}
...
\begin{figure}
      ...
      \caption{Evolución del error absoluto y el error absoluto porcentual en cuantiles en función del periodo para el modelo Stacking (Conf. 5, MLP) (\texttt{carbono\_bruto4}).}
...
\begin{figure}
      ...
      \caption{Gráfico de puntos de las predicciones frente a los valores reales para el modelo Stacking (Conf. 5, MLP) (\texttt{carbono\_bruto4}).}
...
\begin{figure}
      ...
      \caption{Comparación del error absoluto para \texttt{c4} en el IFN2: mejores modelos base globales vs. locales, stacking globales vs. locales, y mejor modelo base vs. mejor stacking.}
...
\begin{figure}
      ...
      \caption{Comparación del error absoluto para \texttt{c4} en el IFN3: mejores modelos base globales vs. locales, stacking globales vs. locales, y mejor modelo base vs. mejor stacking.}
      \label{fig:disc_sub2}
\end{figure}
...
\begin{figure}
      ...
      \caption{Comparación del error absoluto para \texttt{carbono\_bruto4} en el IFN2: mejores modelos base globales vs. locales, stacking globales vs. locales, y mejor modelo base vs. mejor stacking.}
      \label{fig:disc_sub3}
\end{figure}
...
\begin{figure}
      ...
      \caption{Comparación del error absoluto para \texttt{carbono\_bruto4} en el IFN3: mejores modelos base globales vs. locales, stacking globales vs. locales, y mejor modelo base vs. mejor stacking.}
      \label{fig:disc_sub4}
\end{figure}
