...
\vspace{0.25em}
\vspace{0.25em}
\noindent\textbf{Métricas de evaluación.} Las métricas principales empleadas son RMSE, RMSE\%, $R^2$ y SMAPE. En las siguientes expresiones, $y_i$ es el valor observado, $\hat{y}_i$ el predicho, $\bar{y}$ la media observada y $n$ el número de observaciones:
