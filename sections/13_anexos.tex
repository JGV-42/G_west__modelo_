...
Se \correccion{determinará}{determinarán} las fases de desarrollo de las \textit{poblaciones} codificándose de la siguiente forma:
...
\begin{enumerate}
    \item \textbf{No se observan sales, yesos ni procesos de \correccion{fidromorfía}{hidromorfía}.}
...
\correccion{Identificandose}{Identificándose} las siguientes:
\begin{itemize}
