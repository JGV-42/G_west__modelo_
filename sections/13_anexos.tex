...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrr}
        ...
        \textbf{CatBoost} & \textbf{0.84}     & \textbf{0.84}     & \textbf{13.85}      & \textbf{6.61} \\
...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrr}
        ...
        \textbf{CatBoost}          & \textbf{0.80}     & \textbf{0.78}                & \textbf{22.99}                & \textbf{11.61}               \\
        \textbf{LightGBM} & \textbf{0.79}     & \textbf{0.79}    & \textbf{22.77}      & \textbf{11.65} \\
...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrr}
        ...
        Modelo            & CV $R^2$ & $R^2_{\text{test}}$ & RMSE$_{\text{test}}$ & MAE$_{\text{test}}$ \\
        \midrule
        Random Forest     & 0.8580 & 0.8722 & 12.6433 & 6.5331 \\
        XGBoost           & 0.8945 & 0.9072 & 10.7716 & 5.5797 \\
        CatBoost          & 0.8953 & 0.9066 & 10.8074 & 5.5704 \\
        \textbf{LightGBM} & \textbf{0.8956} & \textbf{0.9091} & \textbf{10.6623} & \textbf{5.4774} \\
        GBDT              & 0.8921 & 0.9043 & 10.9423 & 5.7316 \\
        BaggedDT          & 0.8676 & 0.8819 & 12.1541 & 6.4201 \\
        MLP               & 0.8855 & 0.8963 & 11.3916 & 6.3821 \\
        SVR               & 0.8171 & 0.8249 & 14.7974 & 7.1238 \\
        BayesianNN        & 0.8354 & 0.8415 & 14.0794 & 7.8900 \\
        KNN               & 0.7815 & 0.7884 & 16.2702 & 8.1659 \\
        AdaBoost          & 0.5702 & 0.5750 & 23.0560 & 19.5345 \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrr}
        ...
        Modelo            & CV $R^2$ & $R^2_{\text{test}}$ & RMSE$_{\text{test}}$ & MAE$_{\text{test}}$ \\
        \midrule
        Random Forest     & 0.8097 & 0.8260 & 19.7302 & 10.4893 \\
        XGBoost           & 0.8409 & 0.8579 & 17.8277 & 9.2069 \\
        \textbf{CatBoost} & \textbf{0.8396} & \textbf{0.8598} & \textbf{17.7087} & \textbf{9.2504} \\
        LightGBM          & 0.8368 & 0.8577 & 17.8409 & 9.1587 \\
        GBDT              & 0.8364 & 0.8529 & 18.1412 & 9.4626 \\
        BaggedDT          & 0.8136 & 0.8261 & 19.7255 & 10.4018 \\
        MLP               & 0.8099 & 0.8372 & 19.0859 & 10.9172 \\
        SVR               & 0.7327 & 0.7338 & 24.4026 & 11.2189 \\
        BayesianNN        & 0.7691 & 0.7746 & 22.4543 & 12.2597 \\
        KNN               & 0.7406 & 0.7686 & 22.7546 & 12.2522 \\
        AdaBoost          & 0.4514 & 0.4731 & 34.3356 & 26.2947 \\
        \bottomrule
    \end{tabular}
\end{table}
