...
\begin{figure}[htbp]
      ...
      \begin{subfigure}[b]{1.0\linewidth}
            ...
            \label{fig:disc_sub4}
      \end{subfigure}
      \caption{Comparación del error absoluto entre mejores modelos base globales vs. base locales (arriba), mejores modelos de stacking globales vs.  stacking locales (medio) y mejor modelo base vs. mejor modelo de stacking (abajo).}
