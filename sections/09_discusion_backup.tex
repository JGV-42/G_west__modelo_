...
\begin{itemize}
    \item Los datos abarcan un gran rango de valores, de $0$ a $900$ tC/ha. ESTO NO SE VE EN LA IMÁGEN 
    \item La gran mayoría de los datos se encuentran en el rango de $0$ a $200$ tC/ha.
    \item Podemos ver por los valores de densidad que los valores más abundantes son aquellos cercanos a cero FALSO
