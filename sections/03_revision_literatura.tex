...
\end{figure}
Esto hace que mediante un solo sobrevuelo se puedan captar diversas capas a varias alturas, lo que permite realizar reconstrucciones en $3$D de las zona escaneada. El detalle que se puede lograr es tán alto que se pueden identificar los árboles individuales, como se ve en la Figura \ref{fig:chm_example}.


\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figuras/03_revision_literatura/CHM_1.png}
    \caption{Visualización de un bosque escaneado con LiDAR. Vemos las posibilidades de identificar árboles individuales en un entorno forestal denso \cite{roussel2024lidrbook_itd}.}
...
\begin{figure}
    ...
    \caption{Plan de adquisición de datos del Tercer ciclo del proyecto PNOA-LiDAR del Instituto Geográfico Nacional de España \cite{ign_pnoa_lidar_tercera}.}
