...
\section{Resultados}\label{anexo:resultados}
...
\subsection{IFN2 como explicativo para \texttt{c4} (tC/ha)}
...
\subsubsection{Modelos con stacking}
...
\clearpage
\subsection{IFN2 como explicativo para \texttt{carbono\_bruto4} (tC)}
...
\clearpage
\subsection{IFN3 como explicativo para \texttt{c4} (tC/ha)}
...
\clearpage
\subsection{IFN3 como explicativo para \texttt{carbono\_bruto4} (tC)}
...
\clearpage
\subsection{IFN2+IFN3 como explicativos para \texttt{c4} (tC/ha)}
...
\clearpage
\subsection{IFN2+IFN3 como explicativos para \texttt{carbono\_bruto4} (tC)}
